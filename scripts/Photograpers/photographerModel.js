/**
 * @typedef {{id: number; name: string; tagline: string; country: string; city: string; price: number; portrait: string;}} Profile
 */

/**
 * @typedef {{ id: number; photographerId: number; title: string; image: string; likes: number; price: number; price: number; date: string; }[]} Portfolio
 */
